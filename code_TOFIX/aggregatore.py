...
df = pd.read_csv("random_paths_tests_drone5.csv",sep=",")

grouped_multiple = df.groupby(['n_points', 'theta',"spans"]).agg({
...
'BIN_mean', 'BIN_min', 'BIN_max','BIN_std','BIN_var'
]
grouped_multiple = grouped_multiple.reset_index()
print(grouped_multiple)

grouped_multiple.to_csv("aggreagati5.csv")