...
void print_parameters(const input &par) {
    ...
    map<int, string> algorithm_str = {
            ...
            {2, "bin_s_unit_load (APX)"},
            {3, "bin_s_arbitrary_load (HEU)"},
            {4, "knapsack_opt_unit_load"},
            {5, "knapsack_heu_arbitrary_load (HEU)"},
            {6, "col_s (OPT)"},
            // {6, "col_s_unit_load (OPT)"},
            // {7, "col_s_arbitrary_load (HEU)"},
            {8, "greedy_reward_selection_unit_load (HEU)"},
            {9, "greedy_reward_selection_arbitrary_load (HEU)"},
            {10, "greedy_energy_selection_unit_load (HEU)"},
            {11, "greedy_energy_selection_arbitrary_load (HEU)"},
            {12, "greedy_reward_energy_selection_unit_load (HEU)"}, 
            {13, "greedy_reward_energy_selection_arbitrary_load (HEU)"}, 
            {14, "greedy_reward_load_selection_unit_load (HEU)"}, 
            {15, "greedy_reward_load_selection_arbitrary_load (HEU)"}, 
    };
    /// change the list
